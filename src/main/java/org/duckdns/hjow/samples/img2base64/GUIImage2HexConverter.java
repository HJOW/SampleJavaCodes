...
/** GUI 기반 Image2Hex 툴 */
public class GUIImage2HexConverter extends Image2HexConverter implements GUIProgram, Runnable {
    ...
    public GUIImage2HexConverter(SampleJavaCodes superInstance) {
        super();
        init(superInstance);
    }
    ...
    public void onAfterOpened(SampleJavaCodes superInstance) {
        ...
        taRes.setText("이 곳에 HEX 텍스트가 출력됩니다.");
        splits.setDividerLocation(0.7);
    }

    @Override
    public String getTitle() {
        return "Image 2 HEX Converter";
    }
